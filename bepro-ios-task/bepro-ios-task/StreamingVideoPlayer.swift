...
//        playerViewController.showsPlaybackControls = false   // i add this line for removing the playback controls of the videoPlayer it self then i added again cause adjust time is needed.
